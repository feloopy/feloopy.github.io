const phrases = [ 
  ...
  "maximize Yield", "maximize Coverage", "minimize Maintenance Requirements", "maximize Savings", "minimize Requirements", "minimize Lead Time", "maximize Uptime", "minimize Overtime"];
