const phrases = [ 
    ...
    "maximize Closeness", "minimize Cost", "maximize Equity", "minimize Deviation", "maximize ROI", "minimize Consumption",
    "maximize Resilience", "minimize Earliness", "maximize Profit", "minimize Establishments", "maximize Sales",
    "minimize Inventory", "maximize NPV", "minimize Tardiness", "maximize Speed", "minimize Backlog", "maximize Viability",
    ...
    "maximize Efficiency", "minimize Loss", "maximize Effectiveness", "minimize Imports", "maximize Quality"
  ];
  ...
  function startRolling(duration = 2000, speed = 50, pause = 2000) {
    ...
    setTimeout(() => {
      ...
      // Wait a bit before starting the next roll
      setTimeout(() => {
